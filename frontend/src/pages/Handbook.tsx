...
const DEFAULT_HANDBOOK: HandbookData = {
  ...
  sections: [
    ...
    },
    {
      ...
      summary: "Track your long-term progression through the Airbus or Boeing career pathway. Career enrollment is done by staff. View your route discovery %, takeoffs, landings, and aircraft qualifications.",
      content: "The **Career Center** tracks your long-term progression as a pilot.\n\n### Career Pathways\n- **Airbus Pathway** — progression through Airbus fleet ranks.\n- **Boeing Pathway** — progression through Boeing fleet ranks.\n\nCareer path enrollment is done by staff via Admin → Pilots. You cannot self-enroll.\n\n### Rank Ladder\nShows your full rank progression. Each rank node shows:\n- Rank name (e.g., Boeing First Officer)\n- Requirements: route discovery %, required takeoffs, required landings\n- Aircraft types accessible at that rank\n\nCurrent rank: highlighted in **blue**. Past ranks: **green**. Future ranks: **grey**.\n\n### Progress Metrics (for your current rank)\n- **Route Discovery** — % of available routes you've flown vs. the required percentage.\n- **Takeoffs** — count logged vs. required minimum.\n- **Landings** — count logged vs. required minimum.\n\nWhen all three are met, a green **Ready for promotion** banner appears. Contact staff to process the promotion.\n\n### Aircraft Qualifications\nShows which aircraft types are **Unlocked** (accessible now) vs. **Locked** (accessible at a future rank).\n\n### Transfer Requests\nIf you want to switch career pathways (e.g., Airbus → Boeing), submit a transfer request via the Transfers page.",
      image_url: "",
      image_caption: "",
      app_route: "/careers",
      app_route_label: "Go to Career Center"
    },
    {
      id: "transfers",
      chapter: 11,
