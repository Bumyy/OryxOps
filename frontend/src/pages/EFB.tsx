  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-8" ref={revealRef}>
      ...
      <div className="bg-white rounded-2xl border border-brand-border shadow-sm p-6">
        ...
        {/* Content Body */}
        {(ofpData || activeBooking || loadingOfp || simbriefId) ? (
          ...
          <div className="text-center py-16 px-4 max-w-md mx-auto bg-gray-50/50 border border-brand-border rounded-3xl">
            ...
            <h3 className="text-xl font-bold text-brand">No Flight Data Found</h3>
            <p className="text-gray-500 text-sm mt-2 max-w-sm mx-auto leading-relaxed">
              Set your SimBrief Pilot ID in EFB Settings, or book a schedule on the Bookings page to load your flight plan.
            </p>
          </div>
        )}
