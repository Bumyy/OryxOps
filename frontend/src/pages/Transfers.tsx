        ...
        >
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="flex flex-col gap-1">
              <label htmlFor="transfer-type" className="text-xs font-bold text-gray-500">
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor="transfer-to" className="text-xs font-bold text-gray-500">
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor="transfer-reason" className="text-xs font-bold text-gray-500">
                REASON
              </label>
              <input
                id="transfer-reason"
          ...
          <button
            type="submit"
            disabled={loading || !toValue}
            aria-label="Submit transfer request"
            className="rounded-full bg-gradient-to-br from-brand-dark to-brand text-white font-semibold text-sm px-5 py-2 hover:-translate-y-0.5 hover:shadow-lg transition-all disabled:opacity-50 flex items-center gap-2 cursor-pointer"
          >
