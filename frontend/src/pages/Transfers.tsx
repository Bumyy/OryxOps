      ...
      <div className="bg-white rounded-2xl border border-brand-border shadow-sm p-6 mb-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
          <div className="flex flex-col gap-1 text-xs font-medium">
            <label htmlFor="transfer-type" className="text-gray-700 font-semibold">
          ...
          <div className="flex flex-col gap-1 text-xs font-medium">
            <label htmlFor="transfer-target" className="text-gray-700 font-semibold">
          ...
          <div className="flex flex-col gap-1 text-xs font-medium">
            <label htmlFor="transfer-reason" className="text-gray-700 font-semibold">
              Reason (optional)
            </label>
            <input
              id="transfer-reason"
