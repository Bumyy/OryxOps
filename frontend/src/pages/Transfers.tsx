    ...
    <div className="max-w-6xl mx-auto px-6 py-8">
      ...
      <div className="bg-white rounded-2xl border border-brand-border shadow-sm p-6 mb-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
          <div>
            <label htmlFor="transfer-type" className="block text-xs font-bold text-gray-500 mb-1">
              Transfer Type
            </label>
            <select
              id="transfer-type"
          ...
          <div>
            <label htmlFor="transfer-to" className="block text-xs font-bold text-gray-500 mb-1">
              Destination
            </label>
            <input
              id="transfer-to"
          ...
          <div>
            <label htmlFor="transfer-reason" className="block text-xs font-bold text-gray-500 mb-1">
              Reason (Optional)
            </label>
            <input
              id="transfer-reason"
